...
public class BebopVideoView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    //constructor: when BebopVideoView is created initialize using customInit
    ...
    //initializer: setting lock until it's ready
    private void customInit() {
        mReadyLock = new ReentrantLock();
        getHolder().addCallback(this);
    }

    //display video from Drone, using queue data structure
